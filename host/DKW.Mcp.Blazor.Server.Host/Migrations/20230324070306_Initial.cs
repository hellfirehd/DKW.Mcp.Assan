...
namespace DKW.Mcp.Blazor.Server.Host.Migrations
{
	/// <inheritdoc />
		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					ExecutionDuration = table.Column<Int32>(type: "int", nullable: false),
					...
					HttpStatusCode = table.Column<Int32>(type: "int", nullable: true),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					IsStatic = table.Column<Boolean>(type: "bit", nullable: false),
					...
					ValueType = table.Column<Int32>(type: "int", nullable: false),
					ExtraProperties = table.Column<String>(type: "nvarchar(max)", nullable: true),
					ConcurrencyStamp = table.Column<String>(type: "nvarchar(40)", maxLength: 40, nullable: true)
				},
				constraints: table =>
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					IsVisibleToClients = table.Column<Boolean>(type: "bit", nullable: false),
					IsAvailableToHost = table.Column<Boolean>(type: "bit", nullable: false),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					EntityVersion = table.Column<Int32>(type: "int", nullable: false),
					ExtraProperties = table.Column<String>(type: "nvarchar(max)", nullable: true),
					ConcurrencyStamp = table.Column<String>(type: "nvarchar(40)", maxLength: 40, nullable: true),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					ParentName = table.Column<String>(type: "nvarchar(128)", maxLength: 128, nullable: true),
					DisplayName = table.Column<String>(type: "nvarchar(256)", maxLength: 256, nullable: false),
					IsEnabled = table.Column<Boolean>(type: "bit", nullable: false),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					IsDefault = table.Column<Boolean>(type: "bit", nullable: false),
					IsStatic = table.Column<Boolean>(type: "bit", nullable: false),
					IsPublic = table.Column<Boolean>(type: "bit", nullable: false),
					EntityVersion = table.Column<Int32>(type: "int", nullable: false),
					ExtraProperties = table.Column<String>(type: "nvarchar(max)", nullable: true),
					ConcurrencyStamp = table.Column<String>(type: "nvarchar(40)", maxLength: 40, nullable: true)
				},
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					EmailConfirmed = table.Column<Boolean>(type: "bit", nullable: false, defaultValue: false),
					PasswordHash = table.Column<String>(type: "nvarchar(256)", maxLength: 256, nullable: true),
					SecurityStamp = table.Column<String>(type: "nvarchar(256)", maxLength: 256, nullable: false),
					IsExternal = table.Column<Boolean>(type: "bit", nullable: false, defaultValue: false),
					PhoneNumber = table.Column<String>(type: "nvarchar(16)", maxLength: 16, nullable: true),
					PhoneNumberConfirmed = table.Column<Boolean>(type: "bit", nullable: false, defaultValue: false),
					IsActive = table.Column<Boolean>(type: "bit", nullable: false),
					TwoFactorEnabled = table.Column<Boolean>(type: "bit", nullable: false, defaultValue: false),
					LockoutEnd = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
					LockoutEnabled = table.Column<Boolean>(type: "bit", nullable: false, defaultValue: false),
					AccessFailedCount = table.Column<Int32>(type: "int", nullable: false, defaultValue: 0),
					ShouldChangePasswordOnNextLogin = table.Column<Boolean>(type: "bit", nullable: false),
					EntityVersion = table.Column<Int32>(type: "int", nullable: false),
