...
namespace DKW.Abp.AspNetCore.Mvc.UI.Theme.Assan.Themes.Assan.Components.ContentTitle;
...
public class ContentTitleViewComponent : AbpViewComponent
{
	...
	{
		return View("~/Themes/Assan/Components/ContentTitle/Default.cshtml", PageLayout.Content);
	}
}
